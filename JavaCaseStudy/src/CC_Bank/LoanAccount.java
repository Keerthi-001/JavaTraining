...
public abstract class LoanAccount implements BankAccount
{
    ...
    {
        System.out.println("A Loan-Account have been created!");
    ...
    {
        double SI,p,n,r;
        r=10;// The rate of interest for Savings Account is 10%.
        n=2;// The number of years for the savings is 2 years.
        p=45000;// The princple amount deposited is 45,000.
        SI=(p*n*r)/100;
        System.out.println("The Simple interst for the Loan Account is :"+SI);
    }
}
